...
/// </summary>
public class ClassDefinitionTests_AbstractBaseClass_WithBaseClassDirect : ClassDefinitionTests_AbstractBaseClass<TestBaseClass_Abstract>
{
	/// <summary>
	...
	{
		return new ClassDefinition(typeof(TestBaseClass_Abstract), name, (ClassAttributes)attributes);
	}
}
