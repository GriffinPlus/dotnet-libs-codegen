...
public static class Demonstration
{
	...
	public static void Demonstrate()
	{
		...
		viewModel.PropertyChanged += (_, args) => Console.WriteLine($"Property '{args.PropertyName}' has changed.");
	...
	/// uses <see cref="object.Equals(object,object)"/> to determine whether the value has changed.
	/// </summary>
